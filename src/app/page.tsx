...
export default async function PublicCalendarPage({
  ...
  return (
    <PublicCalendarShell>
      ...
      <section className="grid gap-6 rounded-[2rem] border border-[#d8e1ee] bg-white px-6 py-7 shadow-[0_24px_70px_rgba(0,53,128,0.08)] lg:grid-cols-[1.35fr_0.8fr] lg:px-8">
        ...
        <div className="rounded-[1.75rem] bg-[linear-gradient(135deg,#003580_0%,#0b4ca4_60%,#007236_100%)] p-1">
          <div className="flex h-full flex-col justify-between rounded-[1.5rem] bg-white/94 p-5">
            <CoatOfArmsPlaceholder className="min-h-40 bg-white" />
      ...
      <section className="overflow-hidden rounded-[2rem] border border-[#d8e1ee] bg-white shadow-[0_24px_70px_rgba(0,53,128,0.08)]">
        <div className="flex flex-col gap-4 border-b border-slate-200 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-7">
          ...
          <nav className="flex items-center gap-2" aria-label="Calendar month navigation">
            <Link
              ...
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-300 bg-white text-slate-600 transition hover:border-[#003580] hover:text-[#003580]"
            >
              <ChevronLeft className="h-5 w-5" />
            </Link>
            <Link
              href="/"
              className="rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:border-[#003580] hover:text-[#003580]"
            >
              Today
            </Link>
            <Link
