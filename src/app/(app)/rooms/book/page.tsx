  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-muted-foreground">
        Room booking is integrated into activity scheduling.
        Go to <a href="/administrative/events/new" className="text-blue-400 hover:underline">Schedule Activity</a> to book a room.
      </p>
    </div>
  );
}
